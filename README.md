...
**Start a discussion** – **New discussion** on a course's or group's Discussions tab asks for a title and a first post, the way Canvas takes them together, posts it, and opens the thread it made. A course that does not let students start one says so rather than failing quietly.
