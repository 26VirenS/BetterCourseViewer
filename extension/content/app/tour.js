...
(function () {
  ...
  const STOPS = [
    { id: 'stats', route: '/', screen: 'dashboard', target: ['.bcv-stats, .bcv-stat', '.bcv-ph-stats'], title: 'Your day at a glance', text: 'Due today, due this week, unread announcements, overdue, graded this week, classes today. Every number comes from Canvas, and each one opens the list behind it.' },
    { id: 'nav', route: '/', screen: 'dashboard', target: ['.bcv-nav', '#bcv-tabbar'], title: 'Everything in one place', text: ['Dashboard, Courses, Groups, To Do, Calendar, Inbox and Grades. The counts update as you go.', 'Today, Courses, To Do, Grades and Calendar. The bell opens Notifications; Inbox, Groups, the appearance and Settings live under your avatar.'] },
