...
check(Object.values(times).every((ms) => ms >= 240 && ms <= 520) && times.snappy < times.gentle && times.snappy >= 280 && times.gentle >= 440, `every preset settles within half a second, none in a blink — snappy under gentle: ${JSON.stringify(times)}`);
