...
(function () {
  ...
  self.BCV_WHATS_NEW = [
    ...
    { version: '2.98.13', date: '2026-09-25', notes: [
      { kind: 'improved', title: 'Away Refresh, opt-in', body: 'Off for everyone now; the switch under General turns it on.', icon: P.toggle },
    ] },
    ...
    { version: '2.98.3', date: '2026-09-24', notes: [
      ...
      { kind: 'improved', title: 'Shorter command titles', body: 'A command’s list is headed by a few words, not a line.', icon: P.list },
    ] },
