...
try {
  ...
  check(readyRow.tiles === 'Dusk,Ocean,Forest,Sand' && readyRow.thumbs === 16 && readyRow.title === 'Ready-made' && readyRow.on === 0 && readyRow.pvLeft === -40 && !readyRow.clipped && readyRow.step === '0', `four ready-made tiles over the swatches, none on yet, the preview 40px left of centre on the first screen and nothing of it clipped: ${JSON.stringify(readyRow)}`);
